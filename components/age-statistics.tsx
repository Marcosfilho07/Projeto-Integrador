...
function StatSection({ title, participants }: { title: string; participants: Participant[] }) {
    ...
    return (
      <div className="flex flex-col gap-4">
        ...
        <p className="text-sm text-muted-foreground py-8 text-center">
          Nenhum dado disponivel ainda. Registre participantes para ver as estatisticas.
        </p>
      </div>
    )
  }
...
export function AgeStatistics({ labirintoParticipants, elasticoParticipants }: AgeStatisticsProps) {
  return (
    <div className="flex flex-col gap-8">
      <StatSection title="Labirinto" participants={labirintoParticipants} />
      <div className="h-px bg-border" />
      <StatSection title="Elastico com Bolinhas" participants={elasticoParticipants} />
    </div>
  )
}
